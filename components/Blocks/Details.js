...
const Details = ({richText, stickyNavName}) => {
  ...
  return (
      ...
      <section id={`${ stickyNavName != '' ? stickyNavName.toLowerCase() : '' }`} className="c-product-detail h-section-padding">
          ...
          <div className="row">
            <div className="col-md-3">
                        ...
                        <li>
                          {
                            () => {
                              if(feature.level === 1){
                                return (
                                  <a className="c-product-nav__parent js-accordion-toggle" onclick="event.stopPropagation();">{ feature.title }
                                    <div className="c-product-nav__toggle"><i className="material-icons notranslate">keyboard_arrow_down</i></div>
                                  </a>
                                )
                              }else{
                                return feature.url;
              ...
              <div className="c-product-nav__details">
                <p className="p-xtra-sm">Want to see all the features?<br />
                  <a href="/features">
                    See the complete list
                  </a>
                </p>

                <p className="p-xtra-sm">No credit card required.<br />Start your 14-day free trial today.</p>
                <a className="c-button" href="https://app.copper.com/users/sign_up">
                  Free Trial
                </a>
              </div>
            </div>
