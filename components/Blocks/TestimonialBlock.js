        ...
        <section className='testimonial-block bg-white relative'>
            <div className="testimonial__conatiner max-w-7xl m-auto pt-32 pb-32 z-10 relative">
                ...
                <div className="testimonial__content-container flex flex-wrap relative z-10">
                    <div className="testimonial__image-container w-full sm:w-1/2">
                        <div className="testimonial-image max-w-md m-auto">
                    ...
                    <div className="testimonial__quote-container w-full sm:w-1/2 flex flex-col justify-center pl-5">
