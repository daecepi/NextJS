...
const NavigationDefault = () => {
    ...
    return (
      <nav className="fixed top-0 w-full hidden h-6 lg:flex justify-center">
        <div className=' max-w-7xl bg-white px-20 lg:flex w-full items-center justify-between'>
          <div className="flex items-center w-2/3">
            ...
            <ul className="flex items-center h-24">
              <li 
                className={`${ active == "whyCopper" ? "border-b-4 border-radicalRed-500 pt-1" : ""} flex items-center h-full mr-4 hover:border-b-4 hover:border-radicalRed-500 hover:pt-1`}
                
              >
                <div className='cursor-pointer ' onClick={() => toggleMenu("whyCopper")}>Why Copper</div>
                <ul
                  className={` ${
                    active == "whyCopper" ? "block" : "hidden"
                  }  pt-10 pb-10 flex absolute top-full h-60 left-0 w-full max-w-7xl px-20`}
                >
                  <ul className='w-1/3'>
              ...
              >
                ...
                <ul
                  className={` ${
                    active == "industry" ? "block" : "hidden"
                  } absolute top-full h-60 left-0 w-full max-w-7xl px-20`}
                >
                  <li>Agencies</li>
                </ul>
              </li>
          ...
          <div className="w-1/3 text-right pillSection">
            <Pills name="Try Free" url="#" />
          </div>
        </div>
      </nav>
    );
