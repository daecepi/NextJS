const Slider = ({displaG2CrowdModule, displayG2CrowdHeader, g2CrowdHeader, g2CrowdReviews}) =>{
            ...
            <section class="c-single-column slider-section">
              {
                ...
                <h2 class="text-center">{ g2CrowdHeader !== undefined && g2CrowdHeader.length > 0  ? matrixBlock.g2CrowdHeader : 'The recommended CRM<br /> for Google Workspace.' }</h2>
                :
                ''
              }
                                          ...
                                          ceiledValue < 6 ?
                                            <>  
                                              {emptyStarCount.map( (emptyStar) => {
                                                return (<img class="star" alt="Empty star image" src="/imgs/slider/null-star.svg" />)
