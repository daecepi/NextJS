...
const Jumble = (props) => {
	return (
		<section
			className={`c-jumble c-jumble-background--${props.backgroundColor} top-margin-mobile`}
		>
			<div className="container">
				<div className="c-jumble__container col-md-10 no-padding">
					<div className="c-jumble__content c-valign--middle extra-padding">
						<div className="row">
							<div className="col-md-6 order-md-2 relative">
                    ...
                    <source
                      ...
                      alt="Industry agency 1"
                    /> */}
										<img alt="Industry agency 1" src={props.imageUrl} />
									</picture>
								</div>
							</div>
