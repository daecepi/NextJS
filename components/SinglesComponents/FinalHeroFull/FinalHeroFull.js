	...
	return (
		<>
			<section id="" className="c-cols c-cols pricing-style hot-pink">
				<div style={{ position: 'absolute', top: '0px', left: '0px', width: '50%', height: '100%' }}>
					<div className="disappear-mobile" style={{ width: '100%', position: 'relative', height: '100%' }}>
						<picture>
				...
				<div className="container c-animation-container" style={{ position: 'static' }}>
					<h2 className="extra-bottom-margin--x-small" style={{ textAlign: 'center' }}></h2>
					<div className="row column-reverse" style={{ position: 'static' }}>
						<div className="col-md-6 d-flex align-items-center order-1 " style={{ position: 'static' }}>
							<div className="c-image c-image--extended-left c-image--shadow h-remove-shadow" style={{ position: 'static' }}>
								<div
								...
								>
									<Image src="https://copper.objects.frb.io/imgs/pricing/pricing_cta-image-mobile@2x-migration-2.png" width="600" height="454" />
								</div>
							</div>
						</div>
						<div className="col-md-6 c-valign--middle order-2">
							...
							<div className="c-hero__buttons" style={{ flexDirection: 'row' }}>
								<a
									...
									style={{ justifyContent: 'center', marginRight: '5px', width: 'fit-content' }}
								...
								<a
									...
									href="/demos"
									style={{ justifyContent: 'center', marginLeft: '5px', width: 'fit-content' }}
								>
									Request demo
								</a>
							</div>
