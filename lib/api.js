...
export async function getEntryByType(entryType, slug, isFirstTime) {
	const globalsFragments = globalFieldsBuilder();
  ...
  query getEntryByType($slug:[String]){
    ...
    globalSets{
      handle
      ${globalsFragments.call}
    }
  }
  ${globalsFragments.declaration}
  `,
		{
			variables: {
				slug: slug,
