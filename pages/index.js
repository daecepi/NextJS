								...
								<div className="col-md-4 c-card--tool">
									...
									>
										...
										>
											...
											<p className="p-sm multiple-5-card-trailer">
												“I love that Copper is simple, easy to use, and
												intuitive. Our business is all about relationships and
												it helps us build better relationships with our
												clients.”
											</p>
											<cite>
												CRESCENT DIAMOND
									...
									>
										...
										>
											...
											<p className="p-sm multiple-5-card-trailer">
												...
												can't imagine running Storm without having Copper to
												help us compete and win opportunities in the Valley.”
											</p>
											<cite>
												Ryan Floyd
												<span className="c-panel__blockquote--position">
					...
					<div className="container">
						<div className="col-md-8 offset-md-2 c-single-column__container c-align--center no-padding-top">
							...
							<p className="col-md-12">
								Add leads, update deals, look up past interactions, create
								Google Calendar events, and follow up on tasks—right from your
								Gmail inbox.
							</p>
							...
							<div className="col-12 mt-5">
								<div>
									...
									<p className="text-center">
										...
										your interactions and activity, and build an enduring
										business process through Copper's robust customer
						...
						<div className="row column-reverse">
							...
							<div className="col-md-5 offset-md-1 c-valign--middle order-2">
								<div className="col_copy">
									...
									<p>
										Take care of your prospects with complete visibility into
										all your interactions and activity, and build an enduring
										business through Copper's robust customer relationship
					...
					<div className="container c-animation-container">
						...
						<div className="row">
							...
							<div className="col-md-5 c-valign--middle order-1">
								...
								<p>
									With Projects, you can close the deal, and deliver the work,
									all within Copper.
								</p>
								<div className="c-hero__buttons">
