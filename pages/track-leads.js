...
const TrackLeads = () => {
    return (
      <>
            ...
            <div className="row">
              <div className="col-md-10 offset-md-1 c-single-column__container">
                <div className="c-product-focus__media">
                    <Image src='/imgs/product/200309_TrackDeals_UI01.png' width='2002' height='1211 '/>
        ...
        <p class="p-sm">See the number of days a lead has gone without a follow-up so you know when you should reach out.</p>
      </div>
      <div class="col-md-4">
        <h4>Deal Length Monitor</h4>
        <p class="p-sm">See how long a deal has been in any stage of your sales process so you’ll know which ones are dragging and which ones are moving forward.</p>
      </div>
      <div class="col-md-4">
        <h4>Alerts and Notifications</h4>
        <p class="p-sm">Copper sends you real-time notifications that indicate when leads or contacts need your attention.</p>
      </div>

      <div class="col-md-4">
        <h4>Workflow Automation</h4>
        <p class="p-sm">Instead of assigning tasks manually, let Copper automatically assigned time-based tasks to teammates when leads are entered or updated.</p>
      </div>
      <div class="col-md-4">
        <h4>Email Templates</h4>
        <p class="p-sm">Stop writing emails from scratch. With ready-to-use email templates you can answer frequent questions, greet new customers, or promote your service withjust one click.</p>
      </div>
      <div class="col-md-4">
        <h4>Custom Fields</h4>
        <p class="p-sm">Want to track more specific data about your contacts? Add custom fields to record special details that you can use to build better relationships.</p>
      </div>

        <div class="col-md-4">
            <h4>Activity Feed</h4>
            <p class="p-sm">See exactly what’s going on at anytime with the real-time feed of all the activities that are going on with your contacts and accounts.</p>
          </div>
          <div class="col-md-4">
            <h4>Email Open Tracking</h4>
            <p class="p-sm">Easily monitor when a hot lead or customer opens your email so you can send timely follow-ups.</p>
          </div>
          <div class="col-md-4">
            <h4>Custom Opportunity Cards</h4>
            <p class="p-sm">Decide what information is valuable for pending deals by customizing the visual card with critical deal information.</p>
          </div>
        </ThreeColList>
        <FinalCta
