...
const Security = () => {
    return (
      ...
      <div className="col-md-4">
        ...
        <p className="p-sm">To prevent social engineering attacks, Copper utilizes two-factor authentication before granting access to infrastructure that runs the Copper service.</p>
      </div>
      <div className="col-md-4">
        <h4>Regular User Access Review</h4>
        <p className="p-sm">Our employee access to resources is monitored and controlled to make sure we’re always up to date with role and employment status changes.</p>
      </div>
      <div className="col-md-4">
        <h4>Data Security Training</h4>
        <p className="p-sm">Copper provides security awareness training for all employees and requires all employess to review and sign the Employee Code of Conduct.</p>
      </div>
      <div className="col-md-4">
        <h4>Data Encryption</h4>
        <p className="p-sm">Encryption enhances the security of a message or file by scrambling its contents. Copper encrypts your data both in transit and at rest.</p>
      </div>
      <div className="col-md-4">
        <h4>Technical Controls</h4>
        <p className="p-sm">Copper’s security program is designed to protect its networks and systems from malware and unauthorized software and to keep these systems up-to-date.</p>
      </div>
        </ThreeColList>
        <CaseStudy
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-7 c-single-column__container pull-to-center">
                  <h2>Safety first</h2>
                  <p>At Copper, we work hard to ensure that our customer data remains private and secure. If you believe you've discovered a security vulnerability in our product, we want to hear from you.</p>
                  <div className="c-single-column__buttons">
                      <a className="c-button" href="mailto:security@copper.com?subject=Security%20Report" target="_Blanck">Report an issue</a>
                  </div>
