...
const AutomateSells = () => {
    return(
        ...
        <p className="p-sm">Copper automatically assigns time-based tasks to you when leads are entered or updated.</p>
      </div>
      <div className="col-md-4">
        <h4>Recurring Tasks</h4>
        <p className="p-sm">Create one recurring task, tell it how often to reoccur, and set a reminder relative to the task if you want a heads up when it approaches.</p>
      </div>
      <div className="col-md-4">
      ...
      <div className="col-md-4">
        ...
        <p className="p-sm">Stop writing emails from scratch. Use prebuilt emails to answer frequent questions, greet new customers, or promote your service.</p>
      </div>
      <div className="col-md-4">
        <h4>Suggested Contacts</h4>
        <p className="p-sm">Copper scrapes your email history to suggest new leads and contacts to add to the system.</p>
      </div>
      <div className="col-md-4">
        <h4>Task Automation</h4>
        <p className="p-sm">When you update an opportunity from one stage to the next you can automatically trigger the next set of actions in Copper.</p>
      </div>

        <div className="col-md-4">
            <h4>Auto-enrich records</h4>
            <p className="p-sm">Copper scrapes the internet for contact information, social profiles, personal interests and automatically adds it to the record.</p>
          </div>
          <div className="col-md-4">
            <h4>Email Capture</h4>
            <p className="p-sm">Automatically sync emails and contacts in Gmail to companies in Copper—so you have the whole history in one place without having to lift a finger.</p>
          </div>
          <div className="col-md-4">
            <h4>Meeting scheduler </h4>
            <p className="p-sm">Send a meeting request and provide your availability right from Copper.</p>
          </div>
        </ThreeColList>
        <FinalCta
