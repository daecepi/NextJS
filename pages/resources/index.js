...
import { getBlogCategoriesMenu, getBlogFormats, getBlogEntries, getBlogFeaturedEntries, getSingleCaregory } from "../../lib/api";
...
const resources = (props) => {
  ...
  return(
    ...
    <div className='ltr resources blog-body flex'>
      ...
      ></NavigationBlog>
      <Script strategy='lazyOnload' src='https://assets.sitescdn.net/answers/v1.5/answers.min.js'></Script>
      <Script strategy='lazyOnload' src='https://cdn.jsdelivr.net/npm/typed.js@2.0.11'></Script>
      <Script strategy='lazyOnload'src='https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js'></Script>
      <Script 
        ...
        <div className="c-blog-content__main container c-blog-content__main--index"> 
          <div>
            ...
            <div className="row c-copper-chronicles__title">
              <h3 className="col-md-12" id="topOfPagination" style={{fontSize: "20px", lineHeight: "30px"}}>Recent Stories</h3>
            </div>
            <div class="row">
